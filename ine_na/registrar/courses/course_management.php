...
<div class="p-6 bg-white rounded-lg shadow-md">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Manage all available courses in the system</p>
        </div>
        <a href="add_course.php" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
    ...
    <div class="mb-4 flex flex-col sm:flex-row gap-3">
        <div class="relative flex-grow">
            ...
            <input type="text" id="searchInput" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Search courses...">
        </div>
    ...
    <div class="overflow-x-auto bg-white rounded-lg border border-gray-200">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php
                $query = $conn->query("SELECT * FROM courses ORDER BY course_id DESC");
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm font-medium text-gray-900"><?= htmlspecialchars($course['course_name']); ?></div>
                    </td>
                    <td class="px-6 py-4 hidden md:table-cell">
                        <div class="text-sm text-gray-500 max-w-md truncate" title="<?= htmlspecialchars($course['description']); ?>">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex items-center justify-end space-x-2">
                            <a href="edit_course.php?id=<?= $course['course_id']; ?>" 
                               class="text-yellow-600 hover:text-yellow-900 hover:bg-yellow-50 px-2 py-1 rounded transition-colors duration-150"
                               title="Edit">
