...
<title>School Management System - Student Records</title>
...
<input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg border-slate-200 bg-white text-slate-900 focus:border-primary focus:outline-0 focus:ring-0 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:placeholder:text-slate-500 h-full pl-10 pr-4 text-sm font-normal leading-normal" placeholder="Search for students..." value=""/>
</label>
</div>
...
<span class="text-sm font-medium text-slate-900 dark:text-white">Student Records</span>
</div>
<div class="flex flex-col gap-2">
<h1 class="text-3xl font-bold leading-tight tracking-tight text-slate-900 dark:text-white">Student Records</h1>
<p class="text-base font-normal leading-normal text-slate-600 dark:text-slate-400">Manage and view records for all students in your classes.</p>
</div>
...
<option>Grade 5 - Science</option>
<option>Grade 5 - Mathematics</option>
<option>Grade 5 - History</option>
</select>
</div>
...
<th class="py-3 pr-4">Class/Grade</th>
<th class="py-3 pr-4">Current Grade</th>
...
<td class="py-4 pr-4 font-mono text-xs">#S5-0123</td>
<td class="py-4 pr-4 font-medium text-slate-900 dark:text-white">Olivia Martin</td>
<td class="py-4 pr-4">Grade 5</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-green-100 px-2 py-1 text-xs font-medium text-green-700 dark:bg-green-900/50 dark:text-green-300">A (95%)</span>
</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700 dark:bg-blue-900/50 dark:text-blue-300">98%</span>
</td>
<td class="py-4 pl-4 text-right">
<a class="font-medium text-primary hover:underline" href="#">View Record</a>
</td>
</tr>
<tr class="border-b border-slate-200 text-sm text-slate-700 dark:border-slate-800 dark:text-slate-300">
<td class="py-4 pr-4 font-mono text-xs">#S5-0456</td>
<td class="py-4 pr-4 font-medium text-slate-900 dark:text-white">Liam Garcia</td>
<td class="py-4 pr-4">Grade 5</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-yellow-100 px-2 py-1 text-xs font-medium text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300">B (88%)</span>
</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700 dark:bg-blue-900/50 dark:text-blue-300">95%</span>
</td>
<td class="py-4 pl-4 text-right">
<a class="font-medium text-primary hover:underline" href="#">View Record</a>
</td>
...
<tr class="border-b border-slate-200 text-sm text-slate-700 dark:border-slate-800 dark:text-slate-300">
<td class="py-4 pr-4 font-mono text-xs">#S5-0789</td>
<td class="py-4 pr-4 font-medium text-slate-900 dark:text-white">Emma Martinez</td>
<td class="py-4 pr-4">Grade 5</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-green-100 px-2 py-1 text-xs font-medium text-green-700 dark:bg-green-900/50 dark:text-green-300">A- (92%)</span>
</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700 dark:bg-blue-900/50 dark:text-blue-300">99%</span>
</td>
<td class="py-4 pl-4 text-right">
<a class="font-medium text-primary hover:underline" href="#">View Record</a>
</td>
...
<tr class="border-b border-slate-200 text-sm text-slate-700 dark:border-slate-800 dark:text-slate-300">
<td class="py-4 pr-4 font-mono text-xs">#S5-1011</td>
<td class="py-4 pr-4 font-medium text-slate-900 dark:text-white">Noah Rodriguez</td>
<td class="py-4 pr-4">Grade 5</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-red-100 px-2 py-1 text-xs font-medium text-red-700 dark:bg-red-900/50 dark:text-red-300">C+ (78%)</span>
</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-red-100 px-2 py-1 text-xs font-medium text-red-700 dark:bg-red-900/50 dark:text-red-300">85%</span>
</td>
<td class="py-4 pl-4 text-right">
<a class="font-medium text-primary hover:underline" href="#">View Record</a>
</td>
...
<td class="py-4 pr-4 font-mono text-xs">#S5-1213</td>
<td class="py-4 pr-4 font-medium text-slate-900 dark:text-white">Ava Wilson</td>
<td class="py-4 pr-4">Grade 5</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-yellow-100 px-2 py-1 text-xs font-medium text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300">B+ (89%)</span>
</td>
<td class="py-4 pr-4">
<span class="inline-flex items-center rounded-full bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700 dark:bg-blue-900/50 dark:text-blue-300">96%</span>
</td>
<td class="py-4 pl-4 text-right">
<a class="font-medium text-primary hover:underline" href="#">View Record</a>
</td>
...
<span>Showing 1 to 5 of 28 students</span>
<div class="flex items-center gap-2">
